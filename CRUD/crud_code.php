a<?php
    ...
    class Crud_code
    {
        ...
        public function generateCode($length = 5)
        {
            ...
            $req = "insert into code values('$code','$date_debut','$date_fin')";
        ...
        public function sendCode($email)
        {
            ...
            try {
                ...
                $mail->Body    = 'Bonjour ' . $genre . ' ' . $nom . ' ' . $prenom . " <br> c'est votre lien pour verifier votre compte " . '<a href = "localhost:4000/varification.php?token=' . $token . '>Clicker Ici</a>';
                $mail->send();
            } catch (Exception $e) {
