...
<body style="background: #F0F0F0;">
  ...
  <div style="width: 1188px; height: 61px; left: 98px; top: 473px; position: absolute">
    ...
    <div style="width: 86px; height: 25px; left: 360px; top: 0px; position: absolute; text-align: center; color: black; font-size: 20px; font-family: Inter; font-weight: 800; word-wrap: break-word ">Période </i></div>
    <div style="width: 70px; height: 25px; left: 489px; top: 0px; position: absolute; text-align: center; color: black; font-size: 20px; font-family: Inter; font-weight: 800; word-wrap: break-word">Statut<br /></div>
