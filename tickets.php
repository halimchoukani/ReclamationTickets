...
<head>
    ...
    <!-- Custom Stylesheet -->
    <link href="../ReclamationTickets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link href="../ReclamationTickets/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    <link class="main-css" href="../ReclamationTickets/assets/css/style.css" rel="stylesheet">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="../ReclamationTickets/dashboard.php" aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="../ReclamationTickets/gestcompteSA.php" aria-expanded="false">
